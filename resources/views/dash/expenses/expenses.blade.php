    ...
    <x-slot name="main">
        ...
        <div class="p-5">
            <div class="flex justify-content-between items-center">
                <div>
                    <h6 class="font-bold text-xl">Expenses</h6>
                </div>
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    <form method="post" action="{{ route('dash.expenses.export') }}">
                        @csrf
                        <button type="submit"
            ...
            <table id="myTable" class="stripe" style="width:100%">
                ...
                @forelse($expenses as $expense)
                    <tr>
                        ...
                        <td>{{ $expense->type }}</td>
                        <td>{{ $expense->subject->name ?? null }}</td>
                        <td>
                            <div class="flex items-center space-x-6 whitespace-nowrap">
                                <a href="{{ route('dash.expenses.edit', $expense->id) }}"
                                ...
                                <button onclick="deleteRecord({{ $expense->id }})" type="button"
            ...
            <div id="defaultModal" tabindex="-1"
                ...
                <div class="p-4 w-full max-w-2xl h-full md:h-auto">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800">
                        ...
                        <form method="POST" action="{{ route('dash.expenses.store') }}">
                            @csrf
                            <!-- Modal body -->
                            <div class="space-y-4 mb-6">
                                ...
                                <div id="subject-block" class="hidden">
                                    <label for="subject"
