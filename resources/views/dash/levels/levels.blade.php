    ...
    <x-slot name="main">
        ...
        <div class="p-5">
            <div class="flex justify-content-between items-center">
                <div>
                    <h6 class="font-bold text-xl">Levels</h6>
                </div>
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    <form method="post" action="{{ route('dash.levels.export') }}">
                        @csrf
                        <button type="submit"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center space-x-6 whitespace-nowrap">
                                <a href="{{ route('dash.levels.edit', $level->id) }}"
                                ...
                                <button onclick="deleteRecord({{ $level->id }})" type="button"
            ...
            <div id="defaultModal" tabindex="-1"
                ...
                <div class="p-4 w-full max-w-2xl h-full md:h-auto">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800">
                        ...
                        <form method="POST" action="{{ route('dash.levels.store') }}">
                            @csrf
                            <!-- Modal body -->
