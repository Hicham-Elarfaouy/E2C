        ...
        <div class="p-5">
            <div class="flex justify-content-between items-center">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <a href="{{ route('dash.users.add-user') }}" class="inline-flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            ...
            <hr class="my-5">
            <table id="myTable" class="stripe hover order-column compact" style="width:100%">
                <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
