        ...
        <div class="p-5">
            <div class="flex justify-content-between items-center">
                <div class="flex items-center mr-auto">
                    <a href="{{ route('dash.classrooms.index') }}"
                ...
                <div>
                    <h6 class="font-bold text-xl">Classroom</h6>
                </div>
            </div>
            <hr class="my-5">

            <form method="POST" action="{{ route('dash.classrooms.update', $classroom) }}">
                @csrf
                @method('PUT')
                <!-- Modal body -->
                <div class="space-y-4 mb-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Write description here"
                                  required
                                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{{ old('description') ?? $classroom->description }}</textarea>
                    </div>
                </div>
                <!-- Modal footer -->
